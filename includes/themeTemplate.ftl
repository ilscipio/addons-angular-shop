...
<#macro field_markup_container type="" class="" totalColumns="" widgetPostfixColumns="" widgetPostfixCombined="" postfix=false postfixSize=0 postfixContent=true 
  labelArea=true labelType="" labelPosition="" labelContent="" collapse="" collapsePostfix="" norows=false 
        ...
        <#if labelArea && labelPosition == "top">
          <@row>
            <@cell>
              ...
              <span class="input-group-addon field-entry-title ${fieldEntryTypeClass}"><#if !labelContent?is_boolean><@contentArgRender content=labelContent args=labelContentArgs /></#if></span>
